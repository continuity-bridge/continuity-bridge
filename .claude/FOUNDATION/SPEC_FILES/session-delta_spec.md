...
version: v0.3.0
---
# Session Delta Format Specification v1.1
...
Location: `{INSTANCE_HOME}/.claude/memory/session-deltas/`
...
summary: |
  ...
  writes deltas to outputs, Desktop merges deltas back to INSTANCE_HOME.
