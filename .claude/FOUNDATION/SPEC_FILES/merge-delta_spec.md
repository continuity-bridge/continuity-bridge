...
version: v0.3.0
---
# Delta-Merge Format Specification v1.1

## Purpose

Enable Android instances to record changes as deltas that Desktop instances can merge back into INSTANCE_HOME persistence layer.
...
2. **Validate delta**
   ...
   - Check hashes match current INSTANCE_HOME files
...
- v1.1 (2026-03-11): Updated to use `{INSTANCE_HOME}` instead of `CLAUDE_HOME` (INSTANCE_HOME migration)
